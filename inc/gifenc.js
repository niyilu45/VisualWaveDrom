 ...
 * Upstream CommonJS bundle wrapped in a self-contained factory for offline Blob workers.
 * See gifenc-LICENSE.txt. No changes to the encoding implementation.
 */
(function (root) {
  function createGifenc() {
    var module = { exports: {} };
...
var src_default = GIFEncoder;
  ...
  root.VisualWaveDromGifencFactory = createGifenc;
  if (typeof module === "object" && module.exports) module.exports = createGifenc;
